...
# ╔═╡ 6a443526-1bc8-11ed-38b8-8f9b02c44679
using CSV, DataFramesMeta, StatsPlots, ZipFile

# ╔═╡ d668b324-319b-4b3e-957a-cbc81bc65b35
using Downloads

# ╔═╡ 0cd57e89-5aa2-4053-a8a1-b9b45a0f20d6
url = "https://api.worldbank.org/v2/en/indicator/SP.DYN.CDRT.IN?downloadformat=csv";

# ╔═╡ 7277bf27-a2e9-4e3b-8692-bf571e05ceac
downloaded_file = Downloads.download(url);

# ╔═╡ c781fd6a-b7ab-4d54-869c-ed5118cc0509
# turns "_1960" into 1960
...
# ╔═╡ 16ed3f65-9f29-4360-a9fc-993fc1e79303
...
manifest_format = "2.0"
project_hash = "070363eafc8f1fabee92bd4678c753f82a0633c4"
